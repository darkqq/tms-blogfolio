...
import './ThumbUpIcon.css'

const ThumbUpIcon = ({isActive}: any) => {
    return (
        <>
            <svg className={'thumb-up-icon'} width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
